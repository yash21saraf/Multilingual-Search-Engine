...
def timeseries(docs):
	...
	totalsentiments = collections.OrderedDict(sorted(totalsentiments.items()))
	...
	ensentiments = collections.OrderedDict(sorted(ensentiments.items()))
	...
	frsentiments = collections.OrderedDict(sorted(frsentiments.items()))
	...
	politicssentiments = collections.OrderedDict(sorted(politicssentiments.items()))
	...
	crimesentiments = collections.OrderedDict(sorted(crimesentiments.items()))
	...
	environmentsentiments = collections.OrderedDict(sorted(environmentsentiments.items()))
	...
	socialsentiments = collections.OrderedDict(sorted(socialsentiments.items()))
	...
	infrasentiments = collections.OrderedDict(sorted(infrasentiments.items()))
	...
	mexicosentiments = collections.OrderedDict(sorted(mexicosentiments.items()))
	...
	parissentiments = collections.OrderedDict(sorted(parissentiments.items()))
	...
	delhisentiments = collections.OrderedDict(sorted(delhisentiments.items()))
	...
	bangkoksentiments = collections.OrderedDict(sorted(bangkoksentiments.items()))
	...
	nycsentiments = collections.OrderedDict(sorted(nycsentiments.items()))
